/**
 * Universal set cookie for both ssr and browser
 *
 * @param cookieName
 * @param value
 * @param domain
 * @param expiredInMinutes
 * @param path
 * @param secure
 * @param httpOnly
 */
export function setCookie(
  ...
  let cookieString = `${cookieName}=${value}; Expires=${date.toUTCString()}`
...
/**
 * Universal get cookie for both ssr and browser
 *
 * @param cookieName
 * @param stringCookie
 * @returns {string}
 ...
 * @returns {boolean}
 */
export function isAgentMobileOrTablet(userAgent) {
 ...
 * @returns {Promise<T>}
 */
export function boundary(p, defaultErr) {
  return p.then((data) => {
    return data
  }).catch(() => {
